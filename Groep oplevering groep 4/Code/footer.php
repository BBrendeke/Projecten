    ...
    <footer class="footer">
        ...
        <div class="row d-flex text-center justify-content-center mb-md-0 mb-1">
            <div class="col-md-8 col-12 mt-1">
                <p>
                    EenmaalAndermaal is niet aansprakelijk voor (gevolg)schade die voortkomt uit het gebruik van deze
                    site,
                    dan wel uit fouten of ontbrekende functionaliteiten op deze site.
                </p>
            </div>
        </div>
